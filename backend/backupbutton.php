...
$host = "localhost";
$dbname = "suzanydb";
$path = "C:\\xampp\\htdocs\\suzanymobiles.lk\\database\\10_suzanydb.sql";
$backup = exec('C:\\xampp\\mysql\\bin\\mysqldump --user=' . $username . ' --password='. $password .' --host=' . $host . ' ' . $dbname . ' > ' . $path . '');

if (isset($_POST['backup'])) {

        if (file_exists($path)) {

            $message = '<label class="text-success">Backup Success</label>';
            //echo "Backup Success";
            echo "<br>";

        } else {

            $message = '<label class="text-danger">Backup failed!</label>';
            //echo "Backup failed!";
            echo "<br>";
            //$message = '<label class="text-danger">Backup failed!</label>';
...
if (isset($_POST['download'])) {
    ...
    $message = '<label class="text-danger">File does not exist!</label>';
...
<body class="has-side-panel side-panel-right fullwidth-page">
  ...
  <div class="container" style="width:700px;padding-top:8%;padding-bottom:6%;">  
   <h3 align="center"> BACKUP DATABASE OR DOWNLOAD DATABASE</h3>  
   <br />
   <div><?php echo $message; ?></div>
    ...
    <input type="radio" name="backup" align="center"> Backup Database <br>
    
    <input type="radio" name="download" align="center"> Download Database <br>
    <br /><br/> 
    <input type="submit" class="btn btn-info" value="Backup Database" align="center">
