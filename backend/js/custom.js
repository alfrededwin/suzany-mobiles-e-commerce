...
(function($) {
    ...
    ProjectX.isMobile = {
        ...
        any: function() {
            return (ProjectX.isMobile.Android() || ProjectX.isMobile.BlackBerry() || ProjectX.isMobile.iOS() || ProjectX.isMobile.Opera() || ProjectX.isMobile.Windows());
        }
    };
    ...
    ProjectX.bmiCalculator = {
        ...
        calculateStandard: function (bmi_form) {
            ...
            var output = ProjectX.bmiCalculator.magic(bmi);
        ...
        init: function () {
            ...
            bmi_Standard_Form.on('submit', function(e) {
                e.preventDefault();
                ProjectX.bmiCalculator.calculateStandard(bmi_Standard_Form);
                return false;
            });
            ...
            bmi_Metric_Form.on('submit', function(e) {
                e.preventDefault();
                ProjectX.bmiCalculator.calculateMetric(bmi_Metric_Form);
                return false;
            });
        }
    ...
    ProjectX.initialize = {
        ...
        init: function() {
            ProjectX.bmiCalculator.init();
            ProjectX.initialize.TM_toggleNavSearchIcon();
            ProjectX.initialize.TM_fixedFooter();
            ProjectX.initialize.TM_datePicker();
            ProjectX.initialize.TM_ddslick();
            ProjectX.initialize.TM_sliderRange();
            ProjectX.initialize.TM_loadBSParentModal();
            ProjectX.initialize.TM_demoSwitcher();
            ProjectX.initialize.TM_platformDetect();
            ProjectX.initialize.TM_onLoadPopupPromoBox();
            ProjectX.initialize.TM_customDataAttributes();
            ProjectX.initialize.TM_parallaxBgInit();
            ProjectX.initialize.TM_resizeFullscreen();
            ProjectX.initialize.TM_prettyPhoto_lightbox();
            ProjectX.initialize.TM_nivolightbox();
            ProjectX.initialize.TM_fitVids();
            ProjectX.initialize.TM_YTPlayer();
            ProjectX.initialize.TM_equalHeightDivs();
        },
        ...
        TM_parallaxBgInit: function() {
            if (!ProjectX.isMobile.any() && $window.width() >= 800 ) {
    ...
    ProjectX.header = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                ProjectX.header.TM_fullscreenMenu();
                ProjectX.header.TM_sidePanelReveal();
                ProjectX.header.TM_sidePushPanelContent();
                ProjectX.header.TM_scroolToTopOnClick();
                ProjectX.header.TM_scrollToFixed();
                ProjectX.header.TM_sticky();
                ProjectX.header.TM_topnavAnimate();
                ProjectX.header.TM_scrolltoTarget();
                ProjectX.header.TM_navLocalScorll();
                ProjectX.header.TM_menuCollapseOnClick();
                ProjectX.header.TM_homeParallaxFadeEffect();
                ProjectX.header.TM_topsearch_toggle();
            }, 0);
    ...
    ProjectX.widget = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                ProjectX.widget.TM_shopClickEvents();
                ProjectX.widget.TM_fcCalender();
                ProjectX.widget.TM_verticalTimeline();
                ProjectX.widget.TM_verticalMasonryTimeline();
                ProjectX.widget.TM_masonryIsotop();
                ProjectX.widget.TM_pieChart();
                ProjectX.widget.TM_progressBar();
                ProjectX.widget.TM_funfact();
                ProjectX.widget.TM_odometerFunfact();
                ProjectX.widget.TM_instagramFeed();
                ProjectX.widget.TM_jflickrfeed();
                ProjectX.widget.TM_accordion_toggles();
                ProjectX.widget.TM_tooltip();
                //ProjectX.widget.TM_countDownTimer();
            }, 0);
    ...
    ProjectX.slider = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                ProjectX.slider.TM_typedAnimation();
                ProjectX.slider.TM_flexslider();
                ProjectX.slider.TM_owlCarousel();
                ProjectX.slider.TM_maximageSlider();
                ProjectX.slider.TM_bxslider();
                ProjectX.slider.TM_beforeAfterSlider();
            }, 0);
        ...
        TM_flexslider: function() {
            ...
            if ( $each_flex_slider.length > 0 ) {
                ProjectX.widget.TM_portfolioFlexSliderGalleryPopUpInit();
                $each_flex_slider.each(function() {
                    ...
                    $flex_slider.flexslider({
                        ...
                        start: function(slider){
                            ...
                            ProjectX.initialize.TM_magnificPopup_lightbox();
                            ProjectX.initialize.TM_prettyPhoto_lightbox();
                            ProjectX.initialize.TM_nivolightbox();
                        },
                        after: function(){
    ...
    /* ---------------------------------------------------------------------- */
    //document ready
    ProjectX.documentOnReady = {
        init: function() {
            ProjectX.initialize.init();
            ProjectX.header.init();
            ProjectX.slider.init();
            ProjectX.widget.init();
            ProjectX.windowOnscroll.init();
        }
    };

    //window on load
    ProjectX.windowOnLoad = {
        init: function() {
            var t = setTimeout(function() {
                ProjectX.initialize.TM_wow();
                ProjectX.widget.TM_twittie();
                ProjectX.initialize.TM_magnificPopup_lightbox();
                ProjectX.initialize.TM_preLoaderOnLoad();
                ProjectX.initialize.TM_hashForwarding();
                ProjectX.initialize.TM_parallaxBgInit();
            }, 0);
    ...
    //window on scroll
    ProjectX.windowOnscroll = {
        init: function() {
            $window.on( 'scroll', function(){
                ProjectX.header.TM_scroolToTop();
                ProjectX.header.TM_activateMenuItemOnReach();
                ProjectX.header.TM_topnavAnimate();
            });
        }
    };
    ...
    ProjectX.header.TM_menuzord();

    /* ---------------------------------------------------------------------- */
    /* ---------------------------- Call Functions -------------------------- */
    /* ---------------------------------------------------------------------- */
    $document.ready(
        ProjectX.documentOnReady.init
    );
    $window.on('load',
        ProjectX.windowOnLoad.init
    );
    $window.on('resize', 
        ProjectX.windowOnResize.init
    );

    //call function before document ready
    ProjectX.initialize.TM_preLoaderClickDisable();
