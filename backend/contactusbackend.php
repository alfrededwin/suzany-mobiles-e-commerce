              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-bordered" id="myTable">
                    <tr>
                      <th>Operation</th>
                      <th>contactus_name</th>
                      <th>contactus_email</th>
                      <th>contactus_subject</th>
                      <th>contactus_number</th>
                      <th>contactus_message</th>
                    </tr>
                    <tbody>
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?php echo $rows['contactus_name']; ?></td>
                        <td><?php echo $rows['contactus_email']; ?></td>
                        <td><?php echo $rows['contactus_subject']; ?></td>
                        <td><?php echo $rows['contactus_number']; ?></td>
                        <td><?php echo $rows['contactus_message']; ?></td>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="contactusbackend.php" method="post">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" id="txtcontactusname" name="txtcontactusname">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Email</label>
                    <input type="text" class="form-control" id="txtcontactusemail" name="txtcontactusemail">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Subject</label>
                    <select class="form-control" id="txtcontactussubject" name="txtcontactussubject">
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Phone Number</label>
                    <textarea class="form-control" rows="3" id="txtcontactusnumber" name="txtcontactusnumber"></textarea>
                  </div>

                  <div class="form-group col-md-12">
                    <label>Message</label>
                    <input type="email" class="form-control" id="txtcontactusmessage" name="txtcontactusmessage">
                  </div>
