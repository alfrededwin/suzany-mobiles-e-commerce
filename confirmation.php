...
<!-- Page Title -->
<title>Confirmation | Suzany Mobiles</title>
        ...
        <div class="display-table-cell">
          <div class="container pt-0 pb-0"><div class="row">
              ...
              <div class="col-md-8 col-md-offset-2">
                ...
                <p class="font-14 mt-20">We have emailed you the order confirmation. The product will be delivered in 48 hours time<br><b>Thank you!</b></p>
                <div class="pull-center">
                  <button type="submit" class="btn btn-colored btn-theme-colored btn-xs mt-20" data-height="45px" onclick="location.replace('index.php')">Back Home</button>
                  </div>
              </div>
            </div>
          </div>
