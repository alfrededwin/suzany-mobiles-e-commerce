...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2018 at 11:31 PM
...
(14, 'Samsung', 'A3', 50000, 'Blue', '12 Months', 1, 50, 'Latest', 'PH_Galaxy A8.jpg', 'Our vision has always been to create an iPhone that is entirely screen. One so immersive the device itself disappears into the experience. And so intelligent it can respond to a tap, your voice, and even a glance. With iPhone X, that vision is now a reality. Say hello to the future.', 'Our vision has always been to create an iPhone that is entirely screen. One so immersive the device itself disappears into the experience. And so intelligent it can respond to a tap, your voice, and even a glance. With iPhone X, that vision is now a reality. Say hello to the future.The display employs new techniques and technology to precisely follow the curves of the design, all the way to the elegantly rounded corners.', '', '');
...
INSERT INTO `table_line` (`line_id`, `line_qty`, `line_cost`, `customer_id`, `sale_id`, `item_id`) VALUES
(114, 1, 120000, 11, 70, 4);
...
(70, '2018-08-04', '07:48:41', '', 5, 11, 7, 10);
...
--
ALTER TABLE `table_line`
  MODIFY `line_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `table_sale`
--
ALTER TABLE `table_sale`
  MODIFY `sale_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
