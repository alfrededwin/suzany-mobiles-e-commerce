<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM table_employee WHERE employee_email = '$myusername' and employee_password = '$mypassword'";
        ...
        if($count == 1) {
            ...
            //populate id
            $sql_selectEmployee = "SELECT * FROM `table_employee` WHERE `employee_email` = '$myusername'";
            $rs_selectEmployee = mysqli_query($con, $sql_selectEmployee);
            $options_employee_id = "";
            $options_employee_name = "";
            $options_employee_email = "";
            while($row_employee = mysqli_fetch_array($rs_selectEmployee))
            {
                $options_employee_id = $row_employee[0];
                $options_employee_name = $row_employee[1];
                $options_employee_email = $row_employee[4];
            }
            $_SESSION['employee_id'] = $options_employee_id;
            $_SESSION['employee_name'] = $options_employee_name;
            $_SESSION['employee_email'] = $options_employee_email;  
				...
				<section id="home" class=" pb-120 divider parallax fullscreen layer-overlay overlay-dark-9" data-bg-img="images/login/5736d2c89e9cc7cad503fcd640c0f4c78df08a6f.jpg">
					<div class="display-table">
                      ...
                      <img alt="" src="images/logo-wide-white.png">
										...
										<h4 class="text-theme-colored2 mt-0 pt-5"> Admin Portal</h4>

										<form name="login-form" class="form-transparent clearfix" action="signinEmployee.php" method="post">
											<div class="row">
                        ...
                        <input id="form_checkbox" name="form_checkbox" type="checkbox"> Remember me </label>
											...
											<p>Switch to
												<a class="text-theme-colored2" href="signinCustomer.php">Customer?</a>
											</p>
										</form>
									</div>
								</div>
